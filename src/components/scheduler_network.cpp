...
namespace allscale { namespace components {
    void scheduler_network::schedule(std::size_t rank, work_item work, this_work_item::id id, std::vector<hpx::util::function<void()>> register_owned)
    {
        ...
        hpx::apply<enqueue_action>(scheduler_id, std::move(work), std::move(id), std::move(register_owned));
    }
