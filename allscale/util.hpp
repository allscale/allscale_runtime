...
namespace allscale{
		...
		struct SimpleTransferPlanGenerator {
			...
			template<typename DataItemType>
			TransferPlan<DataItemType> operator()(const location_info<DataItemType>& info, locality_type targetLocation, const data_item_requirement<DataItemType>& requirement) {
	...
	TransferPlan<DataItemType> buildPlan(const location_info<DataItemType>& info, locality_type targetLocation, const data_item_requirement<DataItemType>& requirement) {
