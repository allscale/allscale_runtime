...
namespace allscale { namespace components {
            ...
            : hpx::components::managed_component_base<data_item_manager_server >
        {
            ...
            template <typename T>
            hpx::future<allscale::data_item<T> >   create_data_item_async( T  arg)
            {
                using data_item_type = allscale::data_item<T>;
                hpx::lcos::local::promise<allscale::data_item<T> >  promise_;
            ...
            struct create_data_item_async_action
                    : hpx::actions::make_action< hpx::future<allscale::data_item<T> >    (data_item_manager_server::*)(T), &data_item_manager_server::template create_data_item_async<T>, create_data_item_async_action<T> >
            {};
