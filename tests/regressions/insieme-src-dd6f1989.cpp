...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_7(allscale::runtime::dependencies const& var_0, hpx::util::tuple<int32_t, int32_t* > const& var_1) {
...
int32_t IMP_main(int32_t var_0, char** var_1) {
    int32_t var_2;
    int32_t* var_3 = &var_2;
    allscale::runtime::make_prec_operation<int32_t, void >(INS_INIT(hpx::util::tuple<int32_t* >){var_3}, &allscale_fun_7)(1).wait();
    return 0;
}
/* ------- Function Definitions --------- */
...
/* ------- Function Definitions --------- */
void allscale_fun_13(hpx::util::tuple<int32_t, int32_t* > const& var_0) {
    **(int32_t* const*)(&hpx::util::get<1 >(var_0)) + *(int32_t*)(&hpx::util::get<0 >(var_0));
}
/* ------- Function Definitions --------- */
bool allscale_fun_11(hpx::util::tuple<int32_t, int32_t* > const& var_0) {
    return (bool)true;
}
/* ------- Function Definitions --------- */
...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_9(hpx::util::tuple<int32_t, int32_t* > const& var_0) {
    if (allscale_fun_11(var_0)) {
        return allscale_fun_13(var_0),allscale::make_ready_treeture();
    } else {
...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_17(hpx::util::tuple<int32_t, int32_t* > const& var_0) {
...
/* ------- Function Definitions --------- */
void allscale_fun_18(hpx::util::tuple<int32_t, int32_t* > const& var_0) {
