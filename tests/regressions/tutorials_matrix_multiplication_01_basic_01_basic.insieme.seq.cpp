...
/* ------- Function Definitions --------- */
struct std::array<struct std::array<double, 100 >, 100 > IMP__operator_mult_(struct std::array<struct std::array<double, 100 >, 100 > const& var_0, struct std::array<struct std::array<double, 100 >, 100 > const& var_1) {
    struct std::array<struct std::array<double, 100 >, 100 > var_2;
    {
        int32_t var_3 = 0;
        while (var_3 < N) {
            {
    ...
    return (struct std::array<struct std::array<double, 100 >, 100 >&&)var_2;
}
/* ------- Function Definitions --------- */
struct std::array<struct std::array<double, 100 >, 100 > IMP_id() {
    struct std::array<struct std::array<double, 100 >, 100 > var_0;
    {
        int32_t var_1 = 0;
        while (var_1 < N) {
            {
                int32_t var_2 = 0;
                while (var_2 < N) {
                    var_0.operator[]((uint64_t)var_1).operator[]((uint64_t)var_2) = (double)(var_1 == var_2?1:0);
                    var_2++;
                };
            };
            var_1++;
    ...
    return (struct std::array<struct std::array<double, 100 >, 100 >&&)var_0;
}
/* ------- Function Definitions --------- */
int32_t IMP_main() {
    struct std::array<struct std::array<double, 100 >, 100 > var_0 = (struct std::array<struct std::array<double, 100 >, 100 >&&)IMP_id();
    struct std::array<struct std::array<double, 100 >, 100 > var_1 = (struct std::array<struct std::array<double, 100 >, 100 >&&)IMP_id();
    struct std::array<struct std::array<double, 100 >, 100 > var_2 = (struct std::array<struct std::array<double, 100 >, 100 >&&)IMP__operator_mult_(var_0, var_1);
