...
int32_t IMP_main(int32_t var_0, char** var_1) {
    IMP_Data var_2 = {0};
    allscale::runtime::make_prec_operation<int32_t, void >(INS_INIT(hpx::util::tuple<IMP_Data >){(IMP_Data const&)var_2}, &allscale_fun_18)(1).wait();
    return 0;
}
/* ------- Function Definitions --------- */
...
void allscale_fun_24(hpx::util::tuple<int32_t, IMP_Data > const& var_0) {
    (*(const IMP_Data*)(&hpx::util::get<1 >(var_0))).value + *(int32_t*)(&hpx::util::get<0 >(var_0));
}
/* ------- Function Definitions --------- */
