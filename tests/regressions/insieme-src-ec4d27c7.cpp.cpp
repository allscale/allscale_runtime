...
typedef int32_t allscale_type_15(int32_t,int32_t);
...
/* ------- Function Definitions --------- */
int32_t allscale_fun_16(int32_t a, int32_t b) {
    return allscale_fun_18(a, b);
}
/* ------- Function Definitions --------- */
allscale::treeture<int32_t > allscale_fun_14(hpx::util::tuple<int32_t > const& var_0) {
    return allscale::runtime::treeture_combine(std::move((allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1)), std::move((allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2)), &allscale_fun_16);
}
/* ------- Function Definitions --------- */
...
int32_t allscale_fun_20(hpx::util::tuple<int32_t > const& var_0) {
    return allscale_fun_18(rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1}), rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2}));
}
/* ------- Function Definitions --------- */
