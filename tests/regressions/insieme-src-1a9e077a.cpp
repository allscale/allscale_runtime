...
int32_t allscale_fun_4() {
    int32_t b = 10;
//     scanf("%d", &b);
    int32_t r = allscale::runtime::make_prec_operation<int32_t, int32_t >(INS_INIT(hpx::util::tuple< >){}, &allscale_fun_10)(b).get_result();
    printf("fib(%d)=%d\n", b, r);
    return 0;
}
/* ------- Function Definitions --------- */
...
typedef int32_t allscale_type_19(int32_t,int32_t);

/* ------- Function Definitions --------- */
int32_t allscale_fun_22(int32_t b, int32_t var_1) {
    return b + var_1;
}
/* ------- Function Definitions --------- */
int32_t allscale_fun_20(int32_t b, int32_t var_1) {
    return allscale_fun_22(b, var_1);
}
/* ------- Function Definitions --------- */
allscale::treeture<int32_t > allscale_fun_18(hpx::util::tuple<int32_t > const& var_0) {
    return allscale::runtime::treeture_combine(std::move((allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1)), std::move((allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2)), &allscale_fun_20);
}
/* ------- Function Definitions --------- */
...
/* ------- Function Definitions --------- */
allscale::treeture<int32_t > allscale_fun_23(hpx::util::tuple<int32_t > const& var_0) {
...
/* ------- Function Definitions --------- */
int32_t allscale_fun_24(hpx::util::tuple<int32_t > const& var_0) {
    return allscale_fun_22(rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1}), rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2}));
}
/* ------- Function Definitions --------- */
