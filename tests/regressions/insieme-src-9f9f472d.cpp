...
/* ------- Function Definitions --------- */
allscale::treeture<int32_t > allscale_fun_6(allscale::runtime::dependencies const& var_0, hpx::util::tuple<int32_t > const& var_1) {
    return allscale::spawn<__wi_allscale_wi_0_work >(hpx::util::get<0 >(var_1));
}
/* ------- Function Definitions --------- */
int32_t allscale_fun_4() {
    {
        auto fibEager = allscale::runtime::make_prec_operation<int32_t, int32_t >(INS_INIT(hpx::util::tuple< >){}, &allscale_fun_6);
        int32_t v173 = fibEager(12).get_result();
    };
    return 0;
}
/* ------- Function Definitions --------- */
...
allscale::treeture<int32_t > allscale_fun_15(hpx::util::tuple<int32_t > const& var_0) {
    allscale::treeture<int32_t > v173 = (allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1);
    allscale::treeture<int32_t > v178 = (allscale::spawn<__wi_allscale_wi_0_work >)(*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2);
    return allscale::treeture<int32_t >(v173.get_result() + v178.get_result());
}
/* ------- Function Definitions --------- */
bool allscale_fun_10(hpx::util::tuple<int32_t > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<int32_t > allscale_fun_8(hpx::util::tuple<int32_t > const& var_0) {
...
int32_t allscale_fun_18(hpx::util::tuple<int32_t > const& var_0) {
    int32_t v173 = rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 1});
    int32_t v178 = rec(INS_INIT(hpx::util::tuple<int32_t >){*(int32_t*)(&hpx::util::get<0 >(var_0)) - 2});
    return v173 + v178;
}
/* ------- Function Definitions --------- */
