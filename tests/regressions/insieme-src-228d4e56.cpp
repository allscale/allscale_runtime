...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_6(allscale::runtime::dependencies const& var_0, hpx::util::tuple<int32_t > const& var_1) {
    return allscale::spawn<__wi_allscale_wi_0_work >(hpx::util::get<0 >(var_1));
}
/* ------- Function Definitions --------- */
int32_t IMP_main(int32_t var_0, char** var_1) {
    allscale::runtime::make_prec_operation<int32_t, void >(INS_INIT(hpx::util::tuple< >){}, &allscale_fun_6)(1).wait();
    return 0;
}
...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_14(hpx::util::tuple<int32_t > const& var_0) {
    return (void)0,allscale::make_ready_treeture();
}
/* ------- Function Definitions --------- */
void allscale_fun_12(hpx::util::tuple<int32_t > const& var_0) { }
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_8(hpx::util::tuple<int32_t > const& var_0) {
...
struct __wi_allscale_wi_0_variant_0 {
    static allscale::treeture<void > execute(hpx::util::tuple<int32_t > const& var_0);
    static constexpr bool valid = true;
};

allscale::treeture<void > __wi_allscale_wi_0_variant_0::execute(hpx::util::tuple<int32_t > const& var_0) {
    return allscale_fun_8(var_0);
}
/* ------- Function Definitions --------- */
void allscale_fun_16(hpx::util::tuple<int32_t > const& var_0) {
    return (void)0;
}
/* ------- Function Definitions --------- */
void rec(hpx::util::tuple<int32_t > const& var_0) {
    if (allscale_fun_10(var_0)) {
...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_15(hpx::util::tuple<int32_t > const& var_0) {
...
allscale::treeture<void > __wi_allscale_wi_0_variant_1::execute(hpx::util::tuple<int32_t > const& var_0) {
