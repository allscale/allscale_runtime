...
int32_t IMP_main() {
    ...
    std::vector<int32_t, std::allocator<int32_t > >::iterator var_3 = (std::vector<int32_t, std::allocator<int32_t > >::iterator&&)var_2.begin();
    std::vector<int32_t, std::allocator<int32_t > >::iterator var_4 = (std::vector<int32_t, std::allocator<int32_t > >::iterator&&)var_2.end();
    while (var_3 != var_4) {
