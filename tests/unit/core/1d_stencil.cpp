...
struct main_process
{
    ...
    static allscale::treeture<int> execute(Closure const& c)
    {
        ...
        allscale::api::user::data::GridPoint<1> size = 200;
        data_item_shared_data_type sharedData(size);
        allscale::data_item_reference<data_item_type_grid> s_grid = allscale::data_item_manager::create<data_item_type_grid>(sharedData);
