...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_232(allscale::runtime::dependencies const& var_0, hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_1) {
...
int32_t IMP_main(int32_t var_0, char** var_1) {
    ...
    while (var_16 != var_17) {
        ...
        {
            IMP_twoPointCorrelation_7_36_returns_treeture_lt_std_colon__colon_size_t_gt_(var_12, var_18, var_7).get_result();
            var_16.operator++();
        };
    };
    var_11 = var_8.operator()();
...
/* ------- Function Definitions --------- */
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > > > allscale_fun_243(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_236(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_234(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
bool allscale_fun_248(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
uint64_t allscale_fun_252(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
uint64_t allscale_fun_250(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_h_298_2_7_36_returns_std_colon__colon_size_t((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > > const&)hpx::util::get<1 >(var_0), hpx::util::get<2 >(var_0), hpx::util::get<3 >(var_0), ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).box);
}
/* ------- Function Definitions --------- */
uint64_t allscale_fun_246(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_245(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return allscale::treeture<uint64_t >(allscale_fun_246(var_0));
}
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > > > allscale_fun_253(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return INS_INIT(hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > > >){allscale::runtime::createDataItemRequirement((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > > const&)hpx::util::get<1 >(var_0), allscale::api::user::data::StaticBalancedBinaryTreeRegion<36>::closure(hpx::util::get<0 >(var_0).node.getSubtreeIndex()), allscale::runtime::AccessMode::ReadOnly)};
}
struct __wi_allscale_wi_2_variant_1 {
    static allscale::treeture<uint64_t > execute(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0);
...
/* ------- Function Definitions --------- */
bool allscale_fun_254(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 36 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
