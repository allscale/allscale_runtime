...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_231(allscale::runtime::dependencies const& var_0, hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_1) {
...
allscale::treeture<uint64_t > IMP_twoPointCorrelation_7_32_returns_treeture_lt_std_colon__colon_size_t_gt_(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const& var_0, allscale::utils::Vector<float, 7 > const& var_1, float var_2) {
    ...
    return allscale::runtime::make_prec_operation<IMP_Args_instance1, uint64_t >((hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const&)INS_INIT(hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float >){var_0, var_1, var_3}, &allscale_fun_231)((IMP_Args_instance1 const&)INS_INIT(IMP_Args_instance1){(allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >&&)allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >{}, (IMP_BoundingBox_7 const&)var_4});
}
struct IMP_Args;
...
int32_t IMP_main(int32_t var_0, char** var_1) {
    ...
    std::vector<allscale::treeture<uint64_t >> var_15;
    {
        for (uint64_t var_16 = (uint64_t)0; var_16 < var_4; ++var_16) {
            var_15.emplace_back(IMP_twoPointCorrelation_7_32_returns_treeture_lt_std_colon__colon_size_t_gt_(var_12, var_13.operator[]((uint64_t)1), var_7));
        };
    };
...
/* ------- Function Definitions --------- */
/* ------- Function Definitions --------- */
bool allscale_fun_247(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
uint64_t allscale_fun_251(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_h_298_2_7_32_returns_std_colon__colon_size_t((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0), hpx::util::get<2 >(var_0), hpx::util::get<3 >(var_0), ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).box);
}
/* ------- Function Definitions --------- */
uint64_t allscale_fun_245(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_244(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return allscale::treeture<uint64_t >(allscale_fun_245(var_0));
}
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_252(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_242(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return INS_INIT(hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > >){allscale::runtime::createDataItemRequirement((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0), allscale::api::user::data::StaticBalancedBinaryTreeRegion<32>::subtree(hpx::util::get<0 >(var_0).node.getSubtreeIndex()), allscale::runtime::AccessMode::ReadOnly)};
}
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_235(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_233(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
bool allscale_fun_253(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
