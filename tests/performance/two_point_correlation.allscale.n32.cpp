...
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_119(allscale::runtime::dependencies const& var_0, hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_1) {
    return allscale::spawn_first_with_dependencies<__wi_allscale_wi_1_work >(var_0, hpx::util::get<0 >(var_1), hpx::util::get<1 >(var_1));
}
/* ------- Function Definitions --------- */
void allscale_fun_98(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >& var_0, allscale::utils::Vector<float, 7 > const& var_1, allscale::utils::Vector<float, 7 > const& var_2) {
    allscale::runtime::make_prec_operation<IMP_Args, void >((hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const&)INS_INIT(hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > >){(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)var_0}, &allscale_fun_119)((IMP_Args const&)INS_INIT(IMP_Args){(allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >&&)allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >{}, var_1, var_2}).get_result();
}
/* ------- Function Definitions --------- */
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_235(allscale::runtime::dependencies const& var_0, hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_1) {
...
/* ------- Function Definitions --------- */
uint64_t IMP_twoPointCorrelation_7_32_returns_std_colon__colon_size_t(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const& var_0, allscale::utils::Vector<float, 7 > const& var_1, float var_2) {
    float var_3 = var_2 * var_2;
    IMP_BoundingBox_7 var_4;
    return allscale::runtime::make_prec_operation<IMP_Args_instance1, uint64_t >((hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const&)INS_INIT(hpx::util::tuple<allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float >){var_0, var_1, var_3}, &allscale_fun_235)((IMP_Args_instance1 const&)INS_INIT(IMP_Args_instance1){(allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >&&)allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >{}, (IMP_BoundingBox_7 const&)var_4}).get_result();
}
...
int32_t allscale_fun_5(int32_t var_0, char** var_1) {
    ...
    while (var_16 != var_17) {
        ...
        {
            IMP_twoPointCorrelation_7_32_returns_std_colon__colon_size_t(var_12, var_18, var_7);
            var_16.operator++();
        };
    };
    var_11 = var_8.operator()();
...
/* ------- Function Definitions --------- */
bool allscale_fun_148(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    return ((IMP_Args const&)hpx::util::get<0 >(var_0)).node.isLeaf();
}
/* ------- Function Definitions --------- */
bool allscale_fun_154(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
...
allscale::treeture<void > allscale_fun_123(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    ...
    return allscale::runtime::treeture_parallel(allscale::runtime::after(), std::move(allscale::spawn_with_dependencies<__wi_allscale_wi_1_work >(allscale::runtime::after(), (IMP_Args const&)INS_INIT(IMP_Args){(allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >&&)((IMP_Args const&)hpx::util::get<0 >(var_0)).node.getLeftChild(), (allscale::utils::Vector<float, 7 > const&)((IMP_Args const&)hpx::util::get<0 >(var_0)).min, (allscale::utils::Vector<float, 7 > const&)var_5}, (allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0))), std::move(allscale::spawn_with_dependencies<__wi_allscale_wi_1_work >(allscale::runtime::after(), (IMP_Args const&)INS_INIT(IMP_Args){(allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 >&&)((IMP_Args const&)hpx::util::get<0 >(var_0)).node.getRightChild(), (allscale::utils::Vector<float, 7 > const&)var_6, (allscale::utils::Vector<float, 7 > const&)((IMP_Args const&)hpx::util::get<0 >(var_0)).max}, (allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0))));
}
/* ------- Function Definitions --------- */
allscale::treeture<void > allscale_fun_121(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    return allscale_fun_123(var_0);
}
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_142(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
...
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_153(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    return INS_INIT(hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > >){allscale::runtime::createDataItemRequirement((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >&)hpx::util::get<1 >(var_0), allscale::api::user::data::StaticBalancedBinaryTreeRegion<32>::closure(hpx::util::get<0 >(var_0).node.getSubtreeIndex()), allscale::runtime::AccessMode::ReadWrite)};
}
/* ------- Function Prototypes ---------- */
void IMP__lparen_anonymous_space_namespace_rparen__colon__colon_fillSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_100_2_7_32_returns_void(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >& p1, allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 > const& p2, allscale::utils::Vector<float, 7 > const& p3, allscale::utils::Vector<float, 7 > const& p4);

/* ------- Function Definitions --------- */
void allscale_fun_150(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    IMP__lparen_anonymous_space_namespace_rparen__colon__colon_fillSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_100_2_7_32_returns_void((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >&)hpx::util::get<1 >(var_0), ((IMP_Args const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args const&)hpx::util::get<0 >(var_0)).min, ((IMP_Args const&)hpx::util::get<0 >(var_0)).max);
}
/* ------- Function Definitions --------- */
void allscale_fun_152(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    IMP__lparen_anonymous_space_namespace_rparen__colon__colon_fillSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_100_2_7_32_returns_void((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >&)hpx::util::get<1 >(var_0), ((IMP_Args const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args const&)hpx::util::get<0 >(var_0)).min, ((IMP_Args const&)hpx::util::get<0 >(var_0)).max);
    return (void)0;
}
/* ------- Function Definitions --------- */
...
/* ------- Function Definitions --------- */
allscale::runtime::unused_type allscale_fun_145(hpx::util::tuple<IMP_Args, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > const& var_0) {
    rec(var_0);
    return {};
}
struct __wi_allscale_wi_1_variant_1 {
...
/* ------- Function Definitions --------- */
/* ------- Function Definitions --------- */
bool allscale_fun_251(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
bool allscale_fun_257(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Prototypes ---------- */
uint64_t IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const& p1, allscale::utils::Vector<float, 7 > const& p2, float p3, allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 > const& p4, IMP_BoundingBox_7 const& p5);

/* ------- Function Definitions --------- */
uint64_t allscale_fun_255(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0), hpx::util::get<2 >(var_0), hpx::util::get<3 >(var_0), ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).box);
}
/* ------- Function Definitions --------- */
uint64_t allscale_fun_253(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0), hpx::util::get<2 >(var_0), hpx::util::get<3 >(var_0), ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).node, ((IMP_Args_instance1 const&)hpx::util::get<0 >(var_0)).box);
}
/* ------- Function Definitions --------- */
uint64_t allscale_fun_249(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_248(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return allscale::treeture<uint64_t >(allscale_fun_249(var_0));
}
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_256(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
uint64_t IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t(allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const& var_0, allscale::utils::Vector<float, 7 > const& var_1, float var_2, allscale::api::user::data::StaticBalancedBinaryTreeElementAddress<32 > const& var_3, IMP_BoundingBox_7 const& var_4) {
    ...
    return var_7 + IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t(var_0, var_1, var_2, var_3.getLeftChild(), var_8) + IMP__lparen_anonymous_space_namespace_rparen__colon__colon_twoPointCorrelationSequential_slash_home_slash_herbert_slash_coding_slash_c_plus__plus__slash_allscale_compiler_slash_test_slash_data_requirements_slash_binary_tree_slash_two_point_correlation_slash_two_point_correlation_dot_cpp_298_2_7_32_returns_std_colon__colon_size_t(var_0, var_1, var_2, var_3.getRightChild(), var_9);
}
...
/* ------- Function Definitions --------- */
hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > > allscale_fun_246(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
    return INS_INIT(hpx::util::tuple<allscale::runtime::DataItemRequirement<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > >){allscale::runtime::createDataItemRequirement((allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > > const&)hpx::util::get<1 >(var_0), allscale::api::user::data::StaticBalancedBinaryTreeRegion<32>::subtree(hpx::util::get<0 >(var_0).node.getSubtreeIndex()), allscale::runtime::AccessMode::ReadOnly)};
}
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_239(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
...
/* ------- Function Definitions --------- */
allscale::treeture<uint64_t > allscale_fun_237(hpx::util::tuple<IMP_Args_instance1, allscale::runtime::DataItemReference<allscale::api::user::data::StaticBalancedBinaryTree<allscale::utils::Vector<float, 7 >, 32 > >, allscale::utils::Vector<float, 7 >, float > const& var_0) {
