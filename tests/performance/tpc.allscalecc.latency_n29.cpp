...
template<> struct to_std_array_type<allscale_type_261> { using type = std::array<char,29u>; };
...
template<> struct to_std_array_type<allscale_type_259> { using type = std::array<char,15u>; };
...
template<> struct to_std_array_type<allscale_type_260> { using type = std::array<char,12u>; };
...
template<> struct to_std_array_type<allscale_type_258> { using type = std::array<char,6u>; };
...
int32_t IMP_main(int32_t var_0, char** var_1) {
    ...
    while (var_16 != var_17) {
        ...
        {
            IMP_twoPointCorrelation_7_29_returns_treeture_lt_std_colon__colon_size_t_gt_(var_12, var_18, var_7).get_result();
            var_16.operator++();
        };
    };
    var_11 = var_8.operator()();
...
/* ------- Function Definitions --------- */
bool allscale_fun_262(hpx::util::tuple<int32_t, char** > const& var_0) {
    return (bool)false;
}
struct __wi_main_can_split {
