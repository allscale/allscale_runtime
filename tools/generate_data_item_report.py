...
report.write('          box-shadow: inset -1px 0 0 rgba(0, 0, 0, .1);\n')
report.write('        }\n')
report.write('        \n')
...
report.write('                            traces.push(plot_cube(range[0], range[1], \'dash\', info[\'name\'] + \' (\'+ info[\'mode\'] + \') at \' + loc));\n')
report.write('                        });\n')
report.write('                    });\n')
report.write('                }\n')
...
report.write('                            traces.push(plot_cube(range[0], range[1], \'solid\', ref[\'reqs\'][\'mode\']));\n')
report.write('                        });\n');
report.write('                    }\n');
report.write('                });\n')
report.write('                Plotly.newPlot(\'plot\', traces, {width: 1000, height: 600, margin: { l:10, r:0, b:0, t:30}});\n')
report.write('            }\n')
...
report.write('                            ref_item.className = "nav-item btn"\n')
...
report.write('                    </div>\n')
report.write('                </nav>\n')
report.write('                <main role="main"  class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">\n')
